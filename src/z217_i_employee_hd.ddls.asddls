...
define view entity Z217_I_Employee_HD
  as select from /dmo/employ_a_hd

  association of many to one Z217_I_AGENCY_HD    as _Agency   on  $projection.Agency = _Agency.Agency
  association of many to one Z217_I_Employee_HD  as _Manager  on  $projection.Agency  = _Manager.Agency
                                                              and $projection.Manager = _Manager.Employee
  association of many to many Z217_I_Employee_HD as _Employee on  $projection.Agency   = _Employee.Agency
