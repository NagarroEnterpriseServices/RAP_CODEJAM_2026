CLASS LHC_ZR_TRAVEL217  DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES business_user_travel TYPE TABLE FOR READ RESULT ZR_TRAVEL217\\travel.
...
CLASS LHC_ZR_TRAVEL217  IMPLEMENTATION.

  METHOD GetRecommendedValuesFunction.
    READ ENTITIES OF ZR_TRAVEL217 IN LOCAL MODE
       ENTITY Travel
    ...
    LOOP AT business_user_travel ASSIGNING FIELD-SYMBOL(<travel>).
      ...
      DATA(destinations) = /dmo/cl_ai_util_rec=>get_destination_rec_values( description = conv #( <travel>-Description ) ).
